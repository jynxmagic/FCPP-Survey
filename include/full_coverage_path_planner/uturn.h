...
{
class UTurn : public nav_core::BaseGlobalPlanner, private full_coverage_path_planner::FullCoveragePathPlanner
{
public:
  /**
   ...
   */
  static std::list<gridNode_t> move(std::vector<std::vector<bool> > const &grid, std::list<gridNode_t> &init,
   ...
   * @return
   */
  static std::list<Point_t> moveFull(std::vector<std::vector<bool> > const &grid,
                                        Point_t &init,
